...
:RUN
dbService_64 //IS//%1 --DisplayName="%1" --Install=%CURRENT_DIR%dbService_64.exe --Jvm="%JVM_HOME%" --JvmMs=256 --JvmMx=256 --StartMode=jvm --StopMode=jvm --Classpath=%CLASSPATH% --StartClass=%APPNAME% --StartParams="start" --StopClass=%APPNAME% --StopParams="stop"
@echo %1 Installed!
